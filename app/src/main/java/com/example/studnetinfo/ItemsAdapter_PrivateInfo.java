...
public class ItemsAdapter_PrivateInfo extends RecyclerView.Adapter<ItemsAdapter_PrivateInfo.MyViewHolder>{

    Context context;
    private List<Student_data_private_info> ItemsData;

    public ItemsAdapter_PrivateInfo(Context context, List<Student_data_private_info>  ItemsData){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("fatherName", ItemsData.get(position).getFather_Name());
                intent.putExtra("motherName", ItemsData.get(position).getMother_Name());
